...
module.exports = function() {
    ...
    (function (webim) {
        ...
        var proto_logout = function (type , cbOk, cbErr) {
            // 设置当前是否为登录状态
            webim.isLoginStatus = false;
            if (!checkLogin(cbErr, false)) {//不带登录态
                if(webim.isLoginStatus === false) {
                    clearSdk();
                }
                if (cbOk) cbOk({
        ...
        var proto_createGroup = function (options, cbOk, cbErr) {
            ...
            try {
                ...
                throw new BaseError(err, 'WebIMHandler.js[1971]');
            }
        ...
        var proto_modifyGroupMember = function (options, cbOk, cbErr) {
            ...
            try {
                ...
                throw new BaseError(err, 'WebIMHandler.js[2234]');
            }
            //Admin或者Member
            if (options.Role) {
        ...
        var proto_getJoinedGroupListHigh = function (options, cbOk, cbErr) {
            ...
            try {
                ...
                throw new BaseError(err, 'WebIMHandler.js[2294]');
            }
        };
        //查询一组UserId在群中的身份
        ...
        var MsgManager = new function () {
            ...
            var initMyGroupMaxSeqs = function (cbOk, cbErr) {
                ...
                try {
                    ...
                    throw new BaseError(err, 'WebIMHandler.js[3686]');
                }
